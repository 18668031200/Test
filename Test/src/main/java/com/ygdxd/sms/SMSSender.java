...
public class SMSSender {
    ...
    private static final String appKey = "23561858"; // 可替换为您的沙箱环境应用的appKey
    private static final String appSecret = "d782c0b32f2436d0f916b11692aa0a47"; // 可替换为您的沙箱环境应用的appSecret
   // private static final String sessionKey = "test"; // 必须替换为沙箱账号授权得到的真实有效sessionKey
  
    public String getSellerItem(String code,String mobile) throws IOException {
       ...
       // params.put("session", sessionKey);
        ...
        params.put("rec_num", mobile);
        params.put("sms_template_code", "SMS_33670226");
        params.put("sms_free_sign_name","野怪的小弟");
        params.put("sms_type", "normal");
        params.put("sms_param", "{'code':'"+code+"'}");
        // 签名参数
